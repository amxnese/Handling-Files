...
with open('test1.txt' ,'w') as f:
    ...
    f.write('word') # This Overrides The First 'test' We Wrote

    f.seek(0)
    f.write('F') # Now The Text is 'Ford' Because 'F' overrode 'w'

    # Writing Multiple Lines into a File using writelines() Function
